      ...
      {links.map(({ label, href }, index) => {
        ...
        return (
          <Link href={href} passHref scroll={false}>
            <a
              className={`first:ml-0 ml-10 relative after:absolute after:bottom-0 after:left-0 after:w-0 after:transition-all after:duration-300 hover:after:w-full after:h-0.5 ${afterBgColor} xl:ml-16`}
